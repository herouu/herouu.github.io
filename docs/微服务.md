...
```shell
# docker
docker run --name skywalking-oap --restart always -d -p 11800:11800 -p 12800:12800 -p 9412:9412 apache/skywalking-oap-server:latest

docker run --name skywalking-ui --restart always -d -p 8080:8080 -e SW_OAP_ADDRESS=http://172.17.0.1:12800 -e SW_ZIPKIN_ADDRESS=http://172.17.0.1:9412 apache/skywalking-ui:latest
